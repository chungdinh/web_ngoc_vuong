...
function get_items(){		
	...
	$url_link='index.php?com=order&act=man&keyword='.$_GET['keyword'].'&ngaybd='.$_GET['ngaybd'].'&ngaykt='.$_GET['ngaykt'].'&sotien='.$_GET['sotien'].'&httt='.$_GET['httt'].'&tinhtrang='.$_GET['tinhtrang'].'&member='.$_GET['member'];		
}

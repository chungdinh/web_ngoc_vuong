...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
            <li>
                <a href="index.php?com=product&act=man_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <a href="index.php?com=product&act=edit&id_list=<?=$items[$i]['id_list']?>&id_cat=<?=$items[$i]['id_cat']?>&id_item=<?=$items[$i]['id_item']?>&id_sub=<?=$items[$i]['id_sub']?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" class="tipS SC_bold">
                                <img src="<?php echo _upload_product.$items[$i]['photo'] ?>" alt="" style="max-width:200px;">
                            </a>
                        </td>
                        <?php } if($config_noibat){ ?>
                        <td align="center">
                        ...
                        <?php if($config_special){ ?>
                        <td align="center">
                            <a data-val2="table_<?=$_GET['com']?>_list" rel="<?=$items[$i]['special']?>" data-val3="special" class="diamondToggle <?=($items[$i]['special']==1)?" diamondToggleOff":""?>" data-val0="
                                <?=$items[$i]['id']?>" ></a>
                        </td>
                        <?php } ?>
                        <td align="center">

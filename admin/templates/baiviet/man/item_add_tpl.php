...
$(function() {
    ...
    $("#states2").change(function() {
        $idtin = $(this).val();
        if ($idtin > 0) {
            $("#tags_name").append("<p class='delete_tags'>" + $("#states2 option:selected").text() + "<input name='idsanpham[]' value='" + $idtin + "'  type='hidden' /> <span></span> </p>");
        }
    ...
    <div class="control_frm" style="margin-top:25px;">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                <li><a href="index.php?com=baiviet&act=add_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm
    ...
    <form name="supplier" id="validate" class="form" action="index.php?com=baiviet&act=save<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
        <div class="widget">
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    <div class="mt10">
                        <a href="<?=_upload_files.$item['file_baogia']?>" target="_blank" title="">
                            <?=$item['file_baogia']?>
                        </a>
                    </div>
                </div>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    ...
                    <img src="./images/question-button.png" alt="Upload hình" class="icon_question tipS" original-title=" Tải file (doc, docx, xls, xlsx)">
                    <div class="note">
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    <div class="mt10">
                        <img src="<?=_upload_baiviet.$item['photo']?>" alt="PHOTO" width="<?php echo _width_thumb;?>" />
                    </div>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    <div class="mt10">
                        <img src="<?=_upload_baiviet.$item['photo_2']?>" alt="NO PHOTO" width="<?php echo _width_thumb_icon;?>" />
                    </div>
                </div>
                <div class="clear"></div>
            </div>

...
function select_linhvuc() {
    ...
    window.location = "index.php?com=baiviet&act=man_list&type=<?=$_GET['type']?>&id_linhvuc=" + a.value;
    return true;
}
</script>
<?php 
...
<form name="f" id="f" method="post">
    <div class="control_frm" style="margin-top:0;">
        <?php if ($_GET['type'] != 'linhvuc' && $_GET['type'] != 'gioithieu'): ?>
            ...
            <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php } if ($config_images){ ?>
                        <td class="title_name_data" style="width: 90px; text-align: center; background: #42323252">
                            <a href="index.php?com=baiviet&act=edit_list&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" class="tipS SC_bold">
                        ...
                        <?php } if($config_footer){ ?>
                        <td align="center">
                            <a data-val2="table_<?=$_GET['com']?>_list" rel="<?=$items[$i]['footer']?>" data-val3="footer" class="diamondToggle <?=($items[$i]['footer']==1)?" diamondToggleOff":""?>" data-val0="
                                <?=$items[$i]['id']?>" ></a>
                        </td>
                        <?php } ?>
                        <td align="center">
                            <a data-val2="table_<?=$_GET['com']?>_list" rel="<?=$items[$i]['hienthi']?>" data-val3="hienthi" class="diamondToggle <?=($items[$i]['hienthi']==1)?" diamondToggleOff":""?>" data-val0="
                                <?=$items[$i]['id']?>" ></a>
                        </td>
                        <td class="actBtns">

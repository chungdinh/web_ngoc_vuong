<script type="text/javascript">
	...
	function select_linhvuc()
	{
		...
		window.location ="index.php?com=baiviet&act=man_sub&type=<?=$_GET['type']?>&id_linhvuc="+a.value; 
		return true;
	}
	...
	function select_list()
	{
		...
		window.location ="index.php?com=baiviet&act=man_sub&type=<?=$_GET['type']?>&id_list="+a.value+"&id_linhvuc="+b.value; 
		return true;
	}
	...
	function select_cat()
	{
		...
		window.location ="index.php?com=baiviet&act=man_sub&type=<?=$_GET['type']?>&id_list="+a.value+"&id_cat="+b.value+"&id_linhvuc="+c.value;; 
		return true;
	}
	function select_item()
	{
		...
		window.location ="index.php?com=baiviet&act=man_sub&type=<?=$_GET['type']?>&id_list="+a.value+"&id_cat="+b.value+"&id_item="+c.value+"&id_linhvuc="+d.value;; 
		return true;
	}
</script>
<?php

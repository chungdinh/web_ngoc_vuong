<script type="text/javascript">
	...
	function select_linhvuc()
	{
		...
		window.location ="index.php?com=baiviet&act=man_cat&type=<?=$_GET['type']?>&id_linhvuc="+a.value; 
		return true;
	}
	function select_list()
	{
		...
		window.location ="index.php?com=baiviet&act=man_cat&type=<?=$_GET['type']?>&id_list="+a.value<?php if (isset($_GET['id_linhvuc'])): ?>
		+"&id_linhvuc="+b.value
		<?php endif ?>; 
		return true;
	}
		...
		<thead>
			<tr>
				...
				<?php } if ($config_noibat){ ?>
					<td class="tb_data_small"><?=$config_text_noibat?></td>  
				<?php } ?>
			...
			<?php for($i=0, $count=count($items); $i<$count; $i++){?>
				<tr>
					...
					<td align="center">
						...
						<div id="ajaxloader">
							<img class="numloader" id="ajaxloader<?=$items[$i]['id']?>" src="images/loader.gif" alt="loader" /></div>
						</td> 
						<?php if ($config_linhvuc): ?>
							<td align="center">
								<?php

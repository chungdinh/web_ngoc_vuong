        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
            ...
            <tfoot>
                <tr>
                    ...
                    <td>
                        <div class="pagination" id="sum_price">
                            <?=number_format(get_tong_tien($item['id']),0, ',', '.')?>&nbsp;đ</div>
                    </td>
                    <td></td>
                </tr>
            </tfoot>
            <tbody>
                ...
                <tr id="productct<?=$result_ctdonhang[$i]['id']?>">
                    ...
                    <td>
                        ...
                        <p>Size:
                            <?php echo get_size($pid) ?>
                        </p>
                        <?php endif ?>
                        <?php if ($result_ctdonhang[$i]['mausac'] != ''): ?>
                        <p>Màu sắc:
                            <?php echo get_color($pid) ?>
                        </p>
                        <?php endif ?>
                        <p></p>
                    </td>
                    ...
                    <td align="center">
                        <?=number_format($result_ctdonhang[$i]['gia'],0, ',', '.')?>&nbsp;đ</td>
                    ...
                    <td align="center">
                        ...
                        <a href="index.php?com=member&act=edit&id=<?php echo $item['mathanhvien'] ?>" title="<?php echo ten_thanhvien($item['mathanhvien']) ?>">
                            <?php echo ten_thanhvien($item['mathanhvien']) ?></a>
                        <?php else: ?>
                        Không
                        <?php endif; ?>
                    </td>

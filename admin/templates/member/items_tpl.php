...
<form name="f" id="f" method="post">
  ...
  <img src="./images/question-button.png" alt="Chọn loại" class="icon_que tipS" style="display: none; margin:5px 5px 0 0;" original-title="Dùng cây thư mục để di chuyển nhanh đến thành viên">   
</div>
     ...
     <tr>
      ...
      <td align="center">
        ...
        <td align="center">
         ...
         {
          ?>
          <a href="index.php?com=member&act=man&active=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" title="" class="smallButton tipS" original-title="Click để khóa"><img src="./images/icons/color/tick.png" alt=""></a>
          <?php } else { ?>
            <a href="index.php?com=member&act=man&active=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" title="" class="smallButton tipS" original-title="Click để kích hoạt"><img src="./images/icons/color/hide.png" alt=""></a>
            <?php } ?>
          </td> 

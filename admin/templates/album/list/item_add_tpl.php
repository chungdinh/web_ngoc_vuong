...
function get_main_list()
{
	...
	$str='
	<select id="id_list" name="id_list" data-level="0"  data-type="'.$_GET['type'].'" data-child="id_cat" onchange="select_list()" class="main_select select_danhmuc select2">
    ...
    <div class="control_frm" style="margin-top:25px;">
        <div class="bc">
            <ul id="breadcrumbs" class="breadcrumbs">
                <li><a href="index.php?com=album&act=add<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm
    ...
    <form name="supplier" id="validate" class="form" action="index.php?com=album&act=save_list<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" method="post" enctype="multipart/form-data">
        <div class="widget">
            ...
            <div class="formRow">
                ...
                <div class="formRight">
                    <div class="mt10"><strong>
                            <?=$item['photo_2']?></strong></div>
                </div>
                <div class="clear"></div>
            </div>
            <?php } 

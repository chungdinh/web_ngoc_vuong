<?php
$row_lienhe = _fetch_array("SELECT COUNT(id) as num FROM table_contact where view=0 AND type='lienhe'");
$row_lienhe2 = _fetch_array("SELECT COUNT(id) as num FROM table_contact where view=0 AND type='hotro'");
...
<div class="wrapper">
  ...
  <div class="userNav">
    <ul>
      ...
      <li class="ddnew"><a href="index.php?com=contact&act=man&type=lienhe" title=""><img src="images/icons/topnav/messages.png" alt="" /><span>Liên hệ</span><span class="numberTop"><?=$row_lienhe['num']?></span></a>
      </li>
      <li class="ddnew"><a href="../sitemap.php" title=""><img src="images/icons/topnav/messages.png" alt="" /><span>Sitemap</span></a>
      </li>

        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <?php } if ($config_images){ ?>
                    <td align="center">
                        <img src="<?=_upload_hinhanh.$items[$i]['photo_vi']?>" style="max-width: 200px;" border=" 0" alt="" />
                    </td>
                    <?php } ?>
                    <td align="center">
                    ...
                    <td class="actBtns">
                        <a href="index.php?com=photo&act=edit_photo&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" title="" class="smallButton tipS" original-title="Sửa hình ảnh">
                            <img src="./images/icons/dark/pencil.png" alt="">
                        </a>
                        <a href="" onclick="CheckDelete('index.php?com=photo&act=delete_photo&id=<?=$items[$i]['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>'); return false;" title="" class="smallButton tipS" original-title="Xóa hình ảnh">
